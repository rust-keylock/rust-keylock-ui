...
class ChangePassword extends Scene {
  ...
  class Center extends GridPane {
    ...
    add(new Label("Please re-enter your password"), 0, 3)
    add(password2, 1, 3)
    add(passwordMessage2, 1, 4)

    add(new Label("What is your favorite number?"), 0, 5)
    add(number1, 1, 5)
    add(numberMessage1, 1, 6)

    add(new Label("Please re-enter your favorite number"), 0, 7)
    add(number2, 1, 7)
    ...
    private def buttonHandler(): Unit = {
      passwordMessage1.setText("")
      passwordMessage2.setText("")
      numberMessage1.setText("")
      numberMessage2.setText("")

      if (password1.getText() != password2.getText()) {
        passwordMessage2.setText("The provided passwords did not match")
      } else if (number1.getText() != number2.getText()) {
        numberMessage2.setText("The provided favorite numbers did not match")
      } else {
        if (password1.getText().trim().isEmpty()) {
          passwordMessage1.setText("This Field cannot be empty")
          password1.clear()
        } else if (number1.getText().trim().isEmpty()) {
          numberMessage1.setText("This Field cannot be empty")
          number1.clear()
        } else {
