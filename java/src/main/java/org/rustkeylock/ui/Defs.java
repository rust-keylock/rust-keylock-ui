...
public class Defs {
    ...
    public static final String MENU_GET_DBX_TOKEN = "GetDbxToken";
    ...
    public static final String GENERATE_BROWSER_EXTENSION_PASSPHRASE = "GenerateBrowserExtensionPassphrase";
