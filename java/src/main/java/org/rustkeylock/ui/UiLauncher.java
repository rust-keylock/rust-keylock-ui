...
public class UiLauncher extends Application {
    ...
    // java --module-path $RUST_KEYLOCK_UI_BASE_PATH/java/target/lib --add-modules javafx.base,javafx.controls,javafx.graphics,javafx.fxml  -jar $RUST_KEYLOCK_UI_BASE_PATH/java/target/rust-keylock-ui-java-0.13.1.jar
