...
fn main() {
    ...
    println!("cargo:rerun-if-changed=../scala/target/desktop-ui-0.8.2.jar");
...
fn copy_jars_from_scala() {
    ...
    if File::open("../scala/target/desktop-ui-0.8.2.jar").is_ok() {
        ...
        let jar_source_path = "../scala/target/desktop-ui-0.8.2.jar";
